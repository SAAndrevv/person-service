...
insert into medical_card (id,med_status)
values (1, 'N'),
       (2, 'Y'),
       (3, 'N'),
       (4, 'N')
...
insert into person_data (id, last_name, first_name, contact_id, medical_card_id, parent_id)
...
insert into address (id, contact_id)
values (1, 1),
       (2, 3),
       (3, 4)
on conflict do nothing;